...
export function ModalPagamento({ contaId, valorTotal, totalPago, onFechar, onAtualizado }: Props) {
    ...
    <div className="modal-overlay" onClick={onFechar}>
      <div className="modal-caixa" onClick={(e) => e.stopPropagation()} style={{ maxWidth: '520px' }}>
        ...
        <p style={{ fontSize: '13px', color: 'var(--text)', marginBottom: '12px' }}>
          ...
          {' · '}
          Pago: <strong style={{ color: 'var(--text-h)' }}>{formatarMoeda(totalPago)}</strong>
          {' · '}
